...
public class FragmentChest extends Fragment {
    ...
    protected static ArrayList<LogBox> logBoxesChest= new ArrayList<>();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
     ...
     read();
        ...
        adapter = new Adapter2(logBoxesChest, this.getActivity());
        ...
        adapter.setOnItemClickListener(new Adapter2.OnItemClickListener() {
            ...
            public void onItemClick(int pos) {
                chosenLogBox = logBoxesChest.get(pos);
    ...
    public static FragmentChest newInstance(ArrayList<LogBox> logBoxes) {

        Bundle args = new Bundle();

        args.putParcelableArrayList("logBoxes", logBoxes);

        FragmentChest fragment = new FragmentChest();
    ...
    public void read(){
        ...
        try {
            ...
            if(logBoxesChest.isEmpty())
                logBoxesChest = (ArrayList<LogBox>) objectinputstream.readObject();
